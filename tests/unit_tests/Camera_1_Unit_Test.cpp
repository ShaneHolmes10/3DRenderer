...
void test_1() {
    ...
    std::cout << "Did you see 9 red dots in a grid in the center of the screen? ";
    std::cin >> answer;
...
/*
    Check for the changes in position, We do this by shifting the camera to the side by 1000 units
*/
void test_2() {
...
/*
    Check for the changes in orientation, rotate the camera 22.5 deg about the X axis
*/
void test_4() {
...
/*
    Check for the changes in orientation, rotate the camera 22.5 deg about the Y axis
*/
void test_5() {
...
/*
    Check for the changes in orientation, rotate the camera 22.5 deg about the Z axis
*/
void test_6() {
...
void test_9() {
    ...
    std::cout << "Do the dots appear to form a cube, and is that cube rotating? ";
    std::cin >> answer;
...
void test_10() {
    ...
    std::cout << "Do the dots appear to form a cube, is the cube orbiting the camera? ";
    std::cin >> answer;
