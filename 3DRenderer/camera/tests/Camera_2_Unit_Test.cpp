...
/*
    For testing, this will test to see if the camera can successfully check a vector relative to a plane boundary
...
/*
    Generate a sphere that orbits around the camera to verify that there are no point projection errors
*/
void test_17() {
