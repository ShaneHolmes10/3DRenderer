 ...
 * fragments and small for distant ones. Multiplying by fog_density
 * gives a clarity factor in [0, 1]: 1 = fully clear, 0 = fully fogged.
 *
 * Tune fog_density to match your scene scale. Larger values push the
 * fog further away; smaller values bring it closer.
 */
inline FragmentShader<DefaultUniform, DefaultVarying>
    ...
    Eigen::Vector3f out =
        v.color * clarity + fog_color * (1.0f - clarity);
    return out.cast<int>();
};
