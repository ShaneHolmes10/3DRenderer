 ...
 * 
 * This class encapsulates the transformation state of an object in 3D space,
 * including its position, rotation angles, and scale factors. The combined
 * transformation matrix is automatically recalculated whenever any component is modified.
 */
class Transform {
private:
    ...
    * 
    * This matrix represents the complete transformation (translation, rotation, and scale)
    * and is automatically recalculated whenever position, angles, or scale is modified.
    */
    Eigen::Matrix4f matrix;

    /**
    * @brief Recalculates the transformation matrix from position, angles, and scale.
    * 
    * This method combines translation, rotation (from Euler angles), and scale into
    * a single 4x4 transformation matrix. Called automatically by all setters.
    */
...
public:
    ...
    /**
     * @brief Construct a Transform with position and rotation (default scale of 1,1,1).
     * 
     * @param position Position vector (x, y, z)
     * @param euler_rot Euler rotation angles in radians (rx, ry, rz)
     */
     ...
     * 
     * @return const Eigen::Vector3f& Reference to rotation angles (rx, ry, rz) in radians
     */
