...
TEST(Mesh, AddVertexIncreasesCount) {
    ...
    Vertex3 v{Eigen::Vector3f(1.0f, 2.0f, 3.0f),
              Eigen::Vector3i(255, 0, 0)};
    mesh.addVertex(v);
...
TEST(Mesh, AddMultipleVertices) {
    ...
    mesh.addVertex(Vertex3{Eigen::Vector3f(1.0f, 0.0f, 0.0f),
                           Eigen::Vector3i(255, 0, 0)});
    mesh.addVertex(Vertex3{Eigen::Vector3f(0.0f, 1.0f, 0.0f),
                           Eigen::Vector3i(0, 255, 0)});
    mesh.addVertex(Vertex3{Eigen::Vector3f(0.0f, 0.0f, 1.0f),
                           Eigen::Vector3i(0, 0, 255)});
...
TEST(Mesh, AddedVertexIsRetrievable) {
    ...
    Vertex3 v{Eigen::Vector3f(7.0f, 8.0f, 9.0f),
    ...
    CHECK(
        (retrievedVerts[0].position - Eigen::Vector3f(7.0f, 8.0f, 9.0f))
            .norm() < 0.01);
...
TEST(Mesh, AddMultipleFaces) {
    ...
    verts.push_back(Vertex3{Eigen::Vector3f(0.0f, 1.0f, 0.0f),
                            Eigen::Vector3i(0, 0, 255)});
    verts.push_back(Vertex3{Eigen::Vector3f(1.0f, 1.0f, 0.0f),
...
TEST(Mesh, CreateCubeMesh) {
    std::vector<Vertex3> verts;
    verts.push_back(Vertex3{Eigen::Vector3f(-1.0f, -1.0f, -1.0f),
